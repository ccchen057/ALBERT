...
public class TriangleCounter extends Configured implements Tool{
	...
	public int run(String[] args) throws Exception {
		...
		FileOutputFormat.setOutputPath(job1, new Path(args[args.length-1]+"/tmp"));
		...
		FileInputFormat.setInputPaths(job2, new Path(args[args.length-1]+"/tmp"));
		FileOutputFormat.setOutputPath(job2, new Path(args[args.length-1]+"/output"));
