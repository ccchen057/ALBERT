...
workload_config=${root_dir}/conf/workloads/micro/invertedindex.conf
...
run-hadoop-job /home/hadoop/HiBench/bin/app/InvertedIndex/InvertedIndex.jar simple_InvertedIndex.InvertedIndex \
    ...
    -Dmapreduce.job.reduces=24 \
    ${INPUT_HDFS}_10 ${OUTPUT_HDFS} 
END_TIME=`timestamp`
